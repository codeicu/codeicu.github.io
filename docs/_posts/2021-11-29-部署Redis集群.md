...
# 准备文件夹
mkdir -p \
/opt/redis/redis-stable/conf \
/opt/redis/redis-stable/data/7000 \
/opt/redis/redis-stable/data/7001 \
/opt/redis/redis-stable/data/7002 \
/opt/redis/redis-stable/logs/7000 \
/opt/redis/redis-stable/logs/7001 \
/opt/redis/redis-stable/logs/7002

cd /opt/redis

# 创建配置文件
for i in {7000..7002};do sed -e "s/7000/$i/g" /opt/redis/redis.conf > /opt/redis/redis-stable/conf/redis_$i.conf;done
